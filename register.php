...
<body>
	...
	if (isset($_POST['register_button'])) {
		...
		/* If user fails to register, forces registration page to show (keeps error messages). */
	...
	<div class="wrapper">
		...
		<div class="login_box">
			...
			<div id="shown_first">
				...
				<form action="register.php" method="POST" padding: 5%;>
			...
			<div id="shown_second">
				...
				<form action="register.php" method="POST">
					...
					} else if (in_array("That email is already in use.<br>", $error_array)) {
					...
					<br>
					<?php
					if (in_array("Your password must contain at least: 1 lower case letter, 1 upper case letter, 1 number, and 1 symbol.<br>", $error_array)) {
						echo "Your password must contain at least: 1 lower case letter, 1 upper case letter, 1 number, and 1 symbol.<br>";
					} else if (in_array("Your passwords do not match.<br>", $error_array)) {
						echo "Your passwords do not match.<br>";
					} else if (in_array("Your password must contain at least 10 characters.<br>", $error_array)) {
						echo "Your password must contain at least 10 characters.<br>"; 
					}
					?>
